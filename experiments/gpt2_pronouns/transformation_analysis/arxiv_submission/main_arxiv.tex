...
\caption{Geometric decomposition of context transformations showing the percentage contribution of each component. Rotation (45\%) represents reorientation of the representation space, scaling (30\%) captures magnitude adjustments, and translation (25\%) indicates systematic shifts in activation space.}
\label{fig:geometry}
\end{figure}
