...
def continue_clustering(results_dir="results_unified", k_clusters=20):
    """Continue clustering from where it left off."""
...
def main():
    ...
    logger.info("Continuing clustering...")
    ...
    if len(completed) == 12:
        logger.info("All clustering complete! Ready to build trajectories.")
