#!/usr/bin/env python3
"""
Force k=3 clustering for all layers of top 10k GPT-2 tokens.
...
class FixedKClusterer:
    def __init__(self, base_dir: Path, k: int = 3):
    ...
    def run_clustering(self):
        """Run k=3 clustering for all layers."""
        all_labels = {}
        layer_results = {}
        cluster_contents = {}
...
def main():
    ...
    clusterer = FixedKClusterer(base_dir, k=3)
